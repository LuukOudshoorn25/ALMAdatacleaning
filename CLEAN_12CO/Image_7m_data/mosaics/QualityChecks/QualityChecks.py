...
def get_data():
	...
	os.system("cp -r /allegro1/allegro/data/projects/aGqnEW3z/analysis/oudshoorn/CLEAN_12CO/Image_7m_data/TP_12CO_regrid.image ./30Dor_TPalone.image")
	TP_image = "30Dor_TPalone.image"
	#importfits(fitsimage='',imagename='')

	importfits(fitsimage='../7m+TP+nomodel.fits',imagename="30Dor_7m_alone.image")
	IntAlone_image = "30Dor_7m_alone.image"

	importfits(fitsimage='../7m+TP+nomodel.feather.fits',imagename="30Dor_7+feather.image")
	Feather_image = "30Dor_7+feather.image"

	importfits(fitsimage='../7m+TP+model.fits',imagename="30Dor_7m+model.image")
	Model_image = "30Dor_7m+model.image"

	importfits(fitsimage='../7m+TP+model.feather.fits',imagename="30Dor_7m+model_feather.image")
	Hybrid_image = "30Dor_7m+model_feather.image"
